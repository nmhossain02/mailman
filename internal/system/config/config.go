...
func Defaults() File {
	return File{Core: Config{
		Local:    ModelConfig{Backend: "ollama", BaseURL: "http://127.0.0.1:11434", Model: "qwen3:8b", Enabled: true, HealthTimeoutSeconds: 2, InteractiveTimeoutSeconds: 30, BackgroundTimeoutSeconds: 120},
		External: ModelConfig{Backend: "openai", BaseURL: "https://api.openai.com", Model: "gpt-5-mini", Enabled: false, HealthTimeoutSeconds: 2, ExternalTimeoutSeconds: 90},
